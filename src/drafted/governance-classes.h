 ...
 *
 *   // network
 *   CGeekCashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.geekcash.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGeekCashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CGeekCashNetwork(UniValue objIn)
    {
...
// // can be under: GeekCashNetwork
// //   -- signature requirements : Key1(User)
// class CGeekCashNetworkVariable : public CGovernanceObject
// {
// private:
