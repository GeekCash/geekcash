    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("GeekCash") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About GeekCash"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  geekcash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GeekCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GEEK, 0.1 GEEK, 1 GEEK and 10 GEEK -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("GeekCash is shutting down...") + "<br /><br />" +
