    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GeekCash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GeekCash address"));
    ...
    #ifdef Q_OS_MAC
        if (settings.value("fShowMasternodesTab").toBool()) {
            toolsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_6));
        } else {
            toolsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_5));
        }
    #else
        if (settings.value("fShowMasternodesTab").toBool()) {
            toolsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
        } else {
            toolsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
        }
    #endif
    ...
    //aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GeekCash"), this);
    aboutAction = new QAction(tr("&About GeekCash"), this);
    aboutAction->setStatusTip(tr("Show information about GeekCash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GeekCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GeekCash addresses to prove you own them"));
    //verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GeekCash addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the GeekCash help message to get a list with possible GeekCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GeekCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::showInfo()
{
    ...
    walletFrame->gotoToolsPageTab(RPCConsole::TAB_INFO);
}

void BitcoinGUI::showConsole()
{
    toolsAction->setChecked(true);
    walletFrame->gotoToolsPageTab(RPCConsole::TAB_CONSOLE);
}

void BitcoinGUI::showGraph()
{
    toolsAction->setChecked(true);
    walletFrame->gotoToolsPageTab(RPCConsole::TAB_GRAPH);
}

void BitcoinGUI::showPeers()
{
    toolsAction->setChecked(true);
    walletFrame->gotoToolsPageTab(RPCConsole::TAB_PEERS);
}

void BitcoinGUI::showRepair()
{
    toolsAction->setChecked(true);
    walletFrame->gotoToolsPageTab(RPCConsole::TAB_REPAIR);
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GeekCash network", "", count));
    } else {
...
{
    QString strTitle = tr("GeekCash"); // default title
