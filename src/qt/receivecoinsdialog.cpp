    ...
    platformStyle(platformStyle)
{
    ...
    ui->reqMessage->setAttribute(Qt::WA_MacShowFocusRect, false);
    ui->reqAmount->setAttribute(Qt::WA_MacShowFocusRect, false);
    ui->reqLabel->setAttribute(Qt::WA_MacShowFocusRect, false);
