    ...
    platformStyle(platformStyle)
{
    ...
    // normal geekcash address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying geekcash address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());
    ui->payAmount->setAttribute(Qt::WA_MacShowFocusRect, false);
    ui->payTo->setAttribute(Qt::WA_MacShowFocusRect, false);
    ui->addAsLabel->setAttribute(Qt::WA_MacShowFocusRect, false);
    
    // QValidatedLineEdit.setAttribute(Qt::WA_MacShowFocusRect, 0);
