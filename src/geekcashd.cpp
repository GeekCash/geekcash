 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called GeekCash (https://geekcash.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("GeekCash Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  geekcashd [options]                     " + _("Start GeekCash Daemon") + "\n";
