...
{
    if(fLiteMode) return; // disable all GeekCash specific functionality
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_INCREASE_REWARD:                  r = SPORK_15_INCREASE_REWARD_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_INCREASE_REWARD:                  return SPORK_15_INCREASE_REWARD_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_INCREASE_REWARD")                  return SPORK_15_INCREASE_REWARD;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_INCREASE_REWARD:                  return "SPORK_15_INCREASE_REWARD";
