...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "geekcash",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "geekcash",               "voteraw",                &voteraw,                true  },
    { "geekcash",               "mnsync",                 &mnsync,                 true  },
    { "geekcash",               "spork",                  &spork,                  true  },
...
{
    return "> geekcash-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(const std::string& methodname, const std::string& args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6888/\n";
}
