...
typedef enum geekcashconsensus_error_t
{
    geekcashconsensus_ERR_OK = 0,
...
EXPORT_SYMBOL int geekcashconsensus_verify_script(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen,
                                    const unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, geekcashconsensus_error* err);

EXPORT_SYMBOL unsigned int geekcashconsensus_version();
